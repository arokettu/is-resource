 ...
 * @return bool true if var is a resource or an object replacement, false otherwise.
 * @see \is_resource()
 */
 ...
 *
 * @param resource|object $resource The evaluated resource handle or its object replacement.
 * @return string|null If the given handle is a resource or an object replacement, this function
 ...
 * Returns the resource type
 *
 * @param resource|object|mixed $resource $resource The evaluated resource handle or its object replacement.
 * @return string|null null if $resource is not a resource or an object replacement, same as get_resource_type() otherwise.
